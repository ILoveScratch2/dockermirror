...
```shell
docker pull docker.ilovescratch.dpdns.org/stilleshan/frpc:latest
```

```shell
docker pull docker.ilovescratch.dpdns.org/library/nginx:stable-alpine3.19-perl
```
...
{
  "registry-mirrors": ["https://docker.ilovescratch.dpdns.org"]  # 请替换为您自己的Worker自定义域名
}
EOF
